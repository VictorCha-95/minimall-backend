...
class MemberControllerIntegrationTest extends AbstractIntegrationTest {
    ...
    class GetAll {
        ...
        void success() throws Exception {
            //given
            memberService.registerCustomer(createCommand("member1", "손흥민"));
            memberService.registerCustomer(createCommand("member2", "박지성"));
    ...
    class Create{
        ...
        void create_shouldFail_whenDuplicateLoginId() throws Exception {
            //given
            MemberRegisterRequest request1 = createRequest("new123", "새로운 회원1");
    ...
    private void assertMemberSummary(MemberSummaryResult member, ResultActions result) throws Exception {
        result.andExpect(status().isOk())
